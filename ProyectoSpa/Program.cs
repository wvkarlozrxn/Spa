...
public class Compras
{
    ...
    public int _Id_Proveedor { get; set; }  //revisar
...
public class Detalle_Facturas
{
    ...
    public int _Id_Factura { get; set; }
...
public class Facturas
{
    ...
    public int Total { get; set; }
    public int _Id_Reserva { get; set; }
...
public class Productos
{
    ...
    public int _Id_Inventario { get; set; }
...
public class Detalle_Reservas
{
    ...
    public int Precio { get; set; }
    public int _Id_Reserva { get; set; }
    public int _Id_Servico { get; set; }
